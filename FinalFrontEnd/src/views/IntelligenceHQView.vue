    ...
    <div v-if="activeTab === 'summary'" class="tab-content">
      ...
      <div class="summary-grid">
        ...
        <div class="summary-card">
          ...
          <div class="summary-value">{{ countriesCleared }}/{{ totalCountries }}</div>
        </div>
      </div>
    </div>
  </div>
...
<script>
import { getPlayerProgress, getCurrentUserId, getTotalCountries } from '../library/supabase.js';
  ...
  data() {
    return {
      ...
      achievements: [
        ...
        { id: 4, name: 'Global Analyst', icon: '🌍', description: 'Clear all countries', requirement: 'Clear all countries', unlocked: false },
  ...
  methods: {
    async loadPlayerData() {
      ...
      try {
        ...
        this.completionPercent = this.totalCountries > 0 ? Math.round((this.countriesCleared / this.totalCountries) * 100) : 0;
    ...
    checkAchievements() {
      try {
        ...
        // Global Analyst - All countries (dynamic)
        this.achievements[3].unlocked = this.totalCountries > 0 && this.countriesCleared === this.totalCountries;
        this.achievements[3].requirement = `Clear all ${this.totalCountries} countries`;
